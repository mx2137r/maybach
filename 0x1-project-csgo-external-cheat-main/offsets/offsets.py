...
dwForceAttack = 0x3203920
dwForceAttack2 = 0x320392C
dwForceBackward = 0x320395C
dwForceForward = 0x3203950
dwForceJump = 0x527D380
dwForceLeft = 0x3203968
dwForceRight = 0x3203974
dwGameDir = 0x62B900
dwGameRulesProxy = 0x52F0BAC
...
dwPlayerResource = 0x3201CD0
dwRadarBase = 0x52081E4
dwSensitivity = 0xDBD184
dwSensitivityPtr = 0xDBD158
dwSetClanTag = 0x8A3E0
dwViewMatrix = 0x4DC4D84
dwWeaponTable = 0x5225504
dwWeaponTableIndex = 0x326C
dwYawPtr = 0xDBCF48
dwZoomSensitivityRatioPtr = 0xDC31B0
dwbSendPackets = 0xD9722
dwppDirect3DDevice9 = 0xA5050
find_hud_element = 0x2D905200
